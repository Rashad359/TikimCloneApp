...
struct OtherDestinationView: View {
    ...
    @State private var addressInfo: String = ""
            ...
            VStack(spacing: 0) {
                ScrollView {
                    VStack(spacing: 16) {
                        ...
                        DestinationInfo(title: "Adres melumati", placeholder: "Meselen: Central park, Otag 1301", text: $addressInfo)
                ...
                BaseButton(text: "Adresi yadda saxla") {
                    ...
                    addresses.append(.init(title: addressPrefix.isEmpty ? "New address" : addressPrefix, isSelected: true, category: .other, latitude: finalLocation.latitude, longitude: finalLocation.longitude))
...
//
//#Preview {
//    OtherDestinationView(goToAddAddress: .constant(false))
//}
